...
{
    public partial class FrmGenericMasterBase<TID,TEntity> : Form, IFormMaster where TEntity : class, IEntity<TID>
    {
        public FrmGenericMasterBase()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual FrmGenericDetailBase<TID,TEntity> GetDetailForm()
        {
            return null;
        }
        /// <summary>
