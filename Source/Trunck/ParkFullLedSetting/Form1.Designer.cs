namespace ParkFullLedTest
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtWidth = new LJH.GeneralLibrary.WinformControl.IntergerTextBox(this.components);
            this.txtGreetingID = new LJH.GeneralLibrary.WinformControl.IntergerTextBox(this.components);
            this.txtRow = new LJH.GeneralLibrary.WinformControl.IntergerTextBox(this.components);
            this.txtBaud = new LJH.GeneralLibrary.WinformControl.IntergerTextBox(this.components);
            this.txtComport = new LJH.GeneralLibrary.WinformControl.IntergerTextBox(this.components);
            this.txtVacantID = new LJH.GeneralLibrary.WinformControl.IntergerTextBox(this.components);
            ...
            this.txtWidth.MaxValue = 100;
            this.txtWidth.MinValue = 0;
            ...
            this.txtGreetingID.MaxValue = 100000;
            this.txtGreetingID.MinValue = 0;
            ...
            this.txtRow.MaxValue = 100;
            this.txtRow.MinValue = 0;
        ...
        private LJH.GeneralLibrary.WinformControl.IntergerTextBox txtWidth;
        private LJH.GeneralLibrary.WinformControl.IntergerTextBox txtGreetingID;
        private LJH.GeneralLibrary.WinformControl.IntergerTextBox txtRow;
        private LJH.GeneralLibrary.WinformControl.IntergerTextBox txtBaud;
        private LJH.GeneralLibrary.WinformControl.IntergerTextBox txtComport;
        private LJH.GeneralLibrary.WinformControl.IntergerTextBox txtVacantID;
